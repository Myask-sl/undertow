...
public class UndertowEntities {
    public static void register(){
        ...
        EntityRegistry.registerModEntity(EntityClownfishNoir.class, "clownfishNoir", 2, Undertow.instance, 64, 5, false);

        EntityList.addMapping(EntityDrowned.class, "drowned", 255,  0x00FFFF, 0x005500);
        EntityList.addMapping(EntityClownfishNoir.class, "clownfishNoir", 254,  0xF0A000, 0xE0E0E0);
