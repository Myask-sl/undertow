...
public abstract class MixinEntityLivingBase_swiftSwim extends Entity {
    ...
    private void multiplyMotion(EntityLivingBase instance, double vX, double vY, double vZ, Operation<Void> original) {
        float swim_multiplier = 1;
        if (instance instanceof IUndertowPosableEntity alex && alex.undertow$isSwimming())
            swim_multiplier = EnchantmentSwiftSwim.getSwiftSwimMultiplier((EntityLivingBase) (Entity) this, false);
